...
const ColorsToolsCard = () => {
  const filterByColorsTools = CardsData.filter(site => site.category === "Ferramentas de cores");
  return (
    <section id="colection__resource">
      <div className="container">
        <div className="d-flex">
          {filterByColorsTools.map(site => (
...
export default ColorsToolsCard;
