...
const IconsCard = () => {
  const filterByImagesOptimization = CardsData.filter(site => site.category === "Otimização de imagens");
  return (
    <section id="colection__resource">
      <div className="container">
        <div className="d-flex">
          {filterByImagesOptimization.map(site => (
            <div id="site__card" key={site.id}>
              ...
              >
                <h3>{site.name}</h3>
                <a href={site.link} target="_blan" rel="noopener noreferrer">
